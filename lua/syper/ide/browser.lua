...
function Browser:Init()
	...
	self.moveup = self.top:Add("SyperButton")
	...
	self.path_entry = self.top:Add("SyperTextEntry")
	...
	self.name_entry = self.bottom:Add("SyperTextEntry")
